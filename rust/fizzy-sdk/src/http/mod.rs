...
/// keep credentials on the Fizzy origin and read the `Location` a form request was made for.
...
pub trait HttpClient: Send + Sync {
    /// Sends the request and answers what came back, body unread.
...
impl Body {
    /// A body over a stream of chunks, with the length the transport declared, if any.
    pub fn from_stream(
