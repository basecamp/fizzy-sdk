...
//! URL carries its credential in the query (Active Storage direct uploads), so neither the hint nor the source
//! chain may show it.
...
use bytes::Bytes;
use fizzy_sdk::http::{HttpClient, Request, ReqwestClient};
