...
public final class BoardsService: BaseService, @unchecked Sendable {
    ...
    public func delete(accountId: String, boardId: Int) async throws {
        try await requestVoid(
            OperationInfo(service: "Boards", operation: "DeleteBoard", resourceType: "board", isMutation: true, boardId: boardId),
            method: "DELETE",
    ...
    public func get(accountId: String, boardId: Int) async throws -> Board {
        return try await request(
            OperationInfo(service: "Boards", operation: "GetBoard", resourceType: "board", isMutation: false, boardId: boardId),
            method: "GET",
            path: "/\(accountId)/boards/\(boardId)",
    ...
    public func update(accountId: String, boardId: Int, req: UpdateBoardRequest) async throws -> Board {
        return try await request(
            OperationInfo(service: "Boards", operation: "UpdateBoard", resourceType: "board", isMutation: true, boardId: boardId),
            method: "PATCH",
            path: "/\(accountId)/boards/\(boardId)",
            body: req,
