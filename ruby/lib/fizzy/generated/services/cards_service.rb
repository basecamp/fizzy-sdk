...
module Fizzy
  module Services
    ...
    class CardsService < BaseService
      ...
      # @param board_id [Integer, nil] board id
      # @param column_id [Integer, nil] column id
      # @param assignee_id [Integer, nil] assignee id
      ...
      def create(account_id:, title:, board_id: nil, column_id: nil, description: nil, assignee_ids: nil, tag_names: nil)
        with_operation(service: "cards", operation: "CreateCard", is_mutation: true, resource_id: account_id) do
          http_post("/#{account_id}/cards.json", body: compact_params(title: title, board_id: board_id, column_id: column_id, description: description, assignee_ids: assignee_ids, tag_names: tag_names)).json
        end
      end
      ...
      # @return [void]
      def assign(account_id:, card_number:, user_id:)
        with_operation(service: "cards", operation: "AssignCard", is_mutation: true, resource_id: card_number) do
          http_post("/#{account_id}/cards/#{card_number}/assignments.json", body: compact_params(user_id: user_id))
          nil
        end
      end
      ...
      # @return [void]
      def tag(account_id:, card_number:, name:)
        with_operation(service: "cards", operation: "TagCard", is_mutation: true, resource_id: card_number) do
          http_post("/#{account_id}/cards/#{card_number}/taggings.json", body: compact_params(name: name))
          nil
        end
      end
