...
// Get returns a step.
func (s *StepsService) Get(ctx context.Context, cardNumber string, stepID string) (json.RawMessage, *Response, error) {
...
func (s *StepsService) Update(ctx context.Context, cardNumber string, stepID string, req *generated.UpdateStepRequest) (json.RawMessage, *Response, error) {
